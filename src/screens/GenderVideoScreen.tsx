...
const styles = StyleSheet.create({
  ...
  // Player card
  playerWrap: {
    backgroundColor: 'rgba(14,11,5,0.98)',
    borderRadius: 22,
    borderWidth: 1.5,
  ...
  playerHeadEmoji: { fontSize: 22, color: GOLD, fontWeight: '700' },
  playerTitle:     { color: '#fff', fontSize: 14, fontWeight: '800', letterSpacing: 0.3 },
  playerSubLabel:  { color: 'rgba(255,221,127,0.75)', fontSize: 11, marginTop: 2, fontWeight: '500' },
  playerScreen: {
    width: '100%',
    height: SH * 0.35,
    backgroundColor: '#000',
  ...
  ghostBtnText: { color: GOLD, fontSize: 13.5, fontWeight: '700', letterSpacing: 0.2 },
  ...
  formCard: {
    backgroundColor: 'rgba(16,12,7,0.96)',
    borderRadius: 20,
    borderWidth: 1.5,
  ...
  primaryBtnText:     { color: '#000', fontSize: 14.5, fontWeight: '900', letterSpacing: 0.3 },
